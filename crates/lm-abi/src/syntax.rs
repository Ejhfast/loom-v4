...
pub const KIND_FLOAT: u16 = 129;
pub const KIND_BYTES: u16 = 130;
pub const KIND_AMP: u16 = 131;
pub const KIND_CARET: u16 = 132;
pub const KIND_SHL: u16 = 133;
pub const KIND_SHR: u16 = 134;
pub const KIND_USHR: u16 = 135;
pub const KIND_TILDE: u16 = 136;
pub const KIND_CHAR: u16 = 137;
pub const KIND_REGEX: u16 = 138;
...
pub fn syntax_kind_class(kind: u16) -> Option<SyntaxClass> {
    Some(match kind {
        ...
        KIND_INT..=KIND_REGEX => SyntaxClass::Token,
...
pub fn syntax_kind_name(kind: u16) -> Option<&'static str> {
    Some(match kind {
        ...
        KIND_REGEX => "RegexToken",
        KIND_AMP => "AmpersandToken",
        KIND_CARET => "CaretToken",
        KIND_SHL => "ShiftLeftToken",
        KIND_SHR => "ShiftRightToken",
        KIND_USHR => "UnsignedShiftRightToken",
        KIND_TILDE => "TildeToken",
