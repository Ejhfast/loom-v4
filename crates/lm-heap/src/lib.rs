...
pub use shape::{
    dump_shapes, BoundaryPolicy, CodeArtifact, CodeDescriptor, CodeDescriptorKind, CodeHandleKind,
    FaultSite, LinkedCode, LinkedCodeKind, MapEntry, MapEntryArray, MapIndex, NativeRegexMatch,
    Object, PortableCode, PortableCodeKind, PortableCodeStorage, RegexCaptureRange, ShapeDesc,
