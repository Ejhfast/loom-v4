        ...
        match value {
            ...
            HostValue::Ctor(ctor, parts) => {
                let class = match ctor {
                    ...
                    CoreCtor::ProcessInvalidInput => self.core.process_error_invalid_input,
                    CoreCtor::ProcessPermissionDenied => self.core.process_error_permission_denied,
                    CoreCtor::ProcessNotFound => self.core.process_error_not_found,
                    CoreCtor::ProcessFailed => self.core.process_error_failed,
