...
use activation::{
    ...
    allocate_tuple, byte_buffer_append, byte_buffer_build, byte_buffer_extend,
    byte_buffer_find_from, byte_buffer_finish, byte_buffer_new, byte_buffer_reserve, bytes_bit_and,
