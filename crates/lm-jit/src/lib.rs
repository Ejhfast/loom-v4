...
pub use activation::{
    ...
    NativeFrameView, NativeImageSlot, NativeImageSlotView, NativeLiteralView,
    NativePendingInstance, NativePoll, NativePreparation, NativeResolvedCallCache,
    NativeResolvedCallView, NativeRootBuffers, NativeRootBuffersMut, NativeRootError, NativeRoots,
    NativeRuntime, NativeTypeEnvironmentCache, NativeTypeEnvironmentView, PollSchedule,
    RuntimeUnitResult, RuntimeValueResult, ValueArrayAllocationRequest, LOCAL_INITIALIZED,
};
use activation::{
...
impl CompiledRegion {
    ...
    pub fn execute<R: NativeRuntime>(
        ...
        let mut raw_activation = RawNativeActivation {
            ...
            text_view_pages: heap.text_view_pages,
            text_view_page_count: heap.text_view_page_count,
            text_view_slot_count: heap.text_view_slot_count,
