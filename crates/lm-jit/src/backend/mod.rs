...
use lm_heap::{
    ...
    JIT_TEXT_LOOKUP_HASH_OFFSET, JIT_TEXT_PAYLOAD_BYTE_LEN_OFFSET, JIT_TEXT_PAYLOAD_DATA_OFFSET,
    JIT_TEXT_PAYLOAD_LOOKUP_HASH_OFFSET, JIT_TEXT_PAYLOAD_SCALAR_LEN_OFFSET,
    JIT_TEXT_PAYLOAD_SEMANTIC_HASH_OFFSET, JIT_TEXT_SEMANTIC_HASH_OFFSET, JIT_TEXT_VIEW_ENTRY_SIZE,
    JIT_TEXT_VIEW_GENERATION_OFFSET, JIT_TEXT_VIEW_PAGE_MASK, JIT_TEXT_VIEW_PAGE_SHIFT,
    JIT_TEXT_VIEW_PAYLOAD_OFFSET, JIT_TEXT_VIEW_ROOT_OFFSET, JIT_TUPLE_ITEMS_OFFSET,
    MAP_ENTRY_KEY_OFFSET, MAP_ENTRY_SEMANTIC_HASH_OFFSET, MAP_ENTRY_SIZE, MAP_ENTRY_VALUE_OFFSET,
    MAP_SLOT_ENTRY_OFFSET, MAP_SLOT_HASH_OFFSET, MAP_SLOT_SIZE, MIN_OBJECT_COST,
    OWNED_ARRAY_DATA_OFFSET, OWNED_ARRAY_LEN_OFFSET, TEXT_VIEW_GENERATION_TAG,
    VALUE_ARRAY_CAPACITY_OFFSET, VALUE_ARRAY_DATA_OFFSET, VALUE_ARRAY_EMPTY_DATA,
